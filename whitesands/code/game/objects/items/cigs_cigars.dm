...
/*NEW TYPES
nanotransen - smoke, neutraliser chem (makes emotions neutral)?? (or just normal)
donkco - smoke, nutrient
waffleco - smoke, happiness (secret sauce??)
solgov - completely normal (water??)
superfresh - smoke, maint, maint pill (grey bull)
turbo - drugs, weed?
syndicate - healing
